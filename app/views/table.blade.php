...
<div class="ch-container">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Tracking</h2>
    ...
    <tbody> 
        @foreach ($users as $user) 
           <tr>
             <td class='center'>{{$user->module}}</td>
             <td class='center'>{{$user->sub_module}}</td>
             <td class='center'>{{$user->type}}</td>
             <td class='center'>{{$user->duration}}</td>
             <td class='center'>{{$user->duration_played}}</td>
