...
<div class="ch-container">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Pregnancy Messages Played</h2>
    ...
    <tbody> 
        @foreach ($types as $type) 
           <tr>
             ...
             <td class='center'>{{$type->extras}}</td>
    ...
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Trimester Specific Messages Played</h2>
    ...
    <tbody> 
        @foreach ($mgs as $mg) 
           <tr>
             <td class='center'>{{$mg->module}}</td>
             <td class='center'>{{$mg->extras}}</td>
             <td class='center'>{{$mg->sub_module}}</td>
             <td class='center'>{{$mg->c}}</td>
             </tr>
        @endforeach
    ...
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Trimester Specific Messages Duration</h2>
    ...
    <tbody> 
        @foreach ($duration as $d) 
           <tr>
             <td class='center'>{{$d->module}}</td>
             <td class='center'>{{$d->extras}}</td>
             <td class='center'>{{$d->sub_module}}</td>
             <td class='center'>{{$d->duration}}</td>
              <td class='center'>{{$d->duration_played}}</td>
             </tr>
        @endforeach
